...
export default memo(function BondRow({ bond, index, pinned }: Props) {
  ...
  return (
    ...
    >
      ...
      <span
        className="hidden md:block text-[16px] leading-none"
        style={{ color: "var(--text-tertiary)", transform: "rotate(-45deg)" }}
      >
        {"\u2192"}
      </span>
      ...
      <div className="flex items-center gap-4 md:hidden pl-7">
        ...
        <span className="text-[14px] font-bold tabular-nums" style={{ color: apyColor }}>
          {fmtAPY(bond.apy)}
        </span>
        <span className="text-[13px]" style={{ color: expColor }}>
          {label}
        </span>
      </div>
      ...
      <div className="hidden md:flex items-center">
        <span className="text-[15px] font-bold tabular-nums" style={{ color: apyColor }}>
          {fmtAPY(bond.apy)}
        </span>
      </div>

      <div className="hidden md:flex items-center">
        <span className="text-[14px] whitespace-nowrap" style={{ color: expColor }}>
          {label}
        </span>
      </div>
